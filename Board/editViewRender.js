    ...
    <div onclick="openTasktypeDropDown()" id="hiddenlayer" class="hiddenlayer show" ></div>
        ...
        <div class="editView-mainInput">
          <section class="input-section-leftEditView">
              ...
              <input oninput="constantCheck()" class="input-section-left-inputEditView" id="title" type="text" placeholder="Enter a title" />
              ...
              <input oninput="constantCheck()" class="input-section-left-inputEditView dateEditView" id="dueDate" placeholder="dd/mm/yyyy">
              <p class="required d-none">This field is required</p>
            </section>
          ...
          <div class="input-section-right-EditView">
            ...
            <div  class="section-right-selectEditView"  required tabindex="0" onclick="openContactView(); showInput()">
            ...
            <div id="IdForTaskChoise" class="section-right-selectEditView"  onclick="event.stopPropagation(); openTasktypeDropDown()">
