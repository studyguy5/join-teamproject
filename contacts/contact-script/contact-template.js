/**
 * Reference used to track when the first letter of the current contact group changes.
 */
let refFirstLetter;


/**
 * Generates HTML for a contact list entry. Inserts a letter separator if necessary.
 * 
 * @param {Array<Object>} array - Array containing all contact objects.
 * @param {number} index - Index of the contact inside the array.
 * @returns {string} HTML template for the contact entry.
 */
...
/**
 * Generates the contact details view for a specific contact.
 * 
 * @param {Object<string, Object>} object - Object containing contacts (keyed by id).
 * @param {string} id - ID of the contact.
 * @returns {string} HTML template for the floating contact details view.
 */
...
/**
 * Generates the overlay HTML for adding a new contact.
 * 
...
/**
 * Generates the overlay HTML for editing an existing contact.
 * 
 * @param {string} id - ID of the contact being edited.
 * @returns {string} HTML template for the edit-contact overlay.
 */
...
/**
 * Generates a success message template to be shown after creating a contact.
 * 
 * @returns {string} HTML template for success message.
 */
